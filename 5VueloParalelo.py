...
send("go x y z S", 4) # x=+forward, -back y=+left -right, z= +up -down S = speed

send("curve x1 y1 z1 x2 y2 z3 S", 13) # x1 2= +forward, -back  y1 2=+left -right  z1 2= +up -down S = speed
